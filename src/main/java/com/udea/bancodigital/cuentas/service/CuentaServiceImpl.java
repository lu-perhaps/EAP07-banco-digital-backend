...
import com.udea.bancodigital.common.repository.EstadoRepository;
...
public class CuentaServiceImpl implements CuentaService {
    ...
    public CuentaResponse solicitarAperturaCuenta(Long clienteId, AperturaCuentaRequest request) {
        if (clienteId == null) {
            throw new CuentasException("UNAUTHORIZED", "Usuario no autenticado", HttpStatus.UNAUTHORIZED);
        }
        ...
        TipoCuenta tipoCuenta = tipoCuentaRepository.findByNombreIgnoreCase(tipoNombre)
                .orElseThrow(() -> new CuentasException(
    ...
    public CuentaResponse consultarSaldo(Long clienteId, String numeroCuenta) {
        ...
        // HU6 - Criterio 4: Si está BLOQUEADA, la consulta de saldo retribuye saldo + estado 'BLOQUEADA' con HTTP 200
